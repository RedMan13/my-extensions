import { vm } from '../../util/scratch-types.js'
const { IRGenerator, JSGenerator } = Object.assign({}, vm.exports, vm.exports.i_will_not_ask_for_help_when_these_break());

export function compile(thread) {
